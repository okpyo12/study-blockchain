  ...
  updateMatrixWorld(force) {
    ...
    Object.values(this.motionController.components).forEach((component) => {
      Object.values(component.visualResponses).forEach((visualResponse) => {
        ...
        if (!valueNode)
          return;
        if (valueNodeProperty === MotionControllers.MotionControllerConstants.VisualResponseProperty.VISIBILITY) {
          valueNode.visible = value;
        } else if (valueNodeProperty === MotionControllers.MotionControllerConstants.VisualResponseProperty.TRANSFORM) {
...
function findNodes(motionController, scene) {
  Object.values(motionController.components).forEach((component) => {
    ...
    if (type === MotionControllers.MotionControllerConstants.ComponentType.TOUCHPAD) {
    ...
    Object.values(visualResponses).forEach((visualResponse) => {
      ...
      if (valueNodeProperty === MotionControllers.MotionControllerConstants.VisualResponseProperty.TRANSFORM) {
