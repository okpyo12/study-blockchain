...
class KTX2Loader extends THREE.Loader {
  ...
  _createTextureFrom(transcodeResult) {
    ...
    texture.encoding = dfdTransferFn === ktxParse.KHR_DF_TRANSFER_SRGB ? THREE.sRGBEncoding : THREE.LinearEncoding;
...
const ENCODING_MAP = {
  [ktxParse.VK_FORMAT_R8G8B8A8_SRGB]: THREE.sRGBEncoding,
  [ktxParse.VK_FORMAT_R8G8_SRGB]: THREE.sRGBEncoding,
  [ktxParse.VK_FORMAT_R8_SRGB]: THREE.sRGBEncoding
};
