...
class WebGPUTextureUtils {
  constructor(device, glslang) {
    ...
    this.sampler = device.createSampler({ minFilter: constants.GPUFilterMode.Linear });
    this.pipelines = {};
  ...
  getMipmapPipeline(format) {
    ...
    if (pipeline === void 0) {
      pipeline = this.device.createRenderPipeline({
        ...
        primitiveTopology: constants.GPUPrimitiveTopology.TriangleStrip,
        vertexState: {
          indexFormat: constants.GPUIndexFormat.Uint32
        },
        colorStates: [{ format }]
      });
...
module.exports = WebGPUTextureUtils;
