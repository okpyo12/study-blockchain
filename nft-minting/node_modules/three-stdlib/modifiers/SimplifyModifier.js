...
class SimplifyModifier {
  constructor() {
    this.computeEdgeCollapseCost = (u, v) => {
    ...
    this.computeEdgeCostAtVertex = (v) => {
    ...
    this.collapse = (vertices, faces, u, v) => {
      if (!v) {
