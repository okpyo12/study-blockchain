...
class EdgeSplitModifier {
  constructor() {
    ...
    this.edgeSplitToGroups = (indexes, cutOff, firstIndex) => {
      this.A.set(
    ...
    this.edgeSplit = (indexes, cutOff, original = null) => {
      if (indexes.length === 0)
        return;
      const groupResults = [];
    ...
    this.modify = (geometry, cutOffAngle, tryKeepNormals = true) => {
